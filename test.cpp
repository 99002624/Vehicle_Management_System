    ...
    void SetUp() {
        ...
        for(iter=res.begin(); iter!=res.end(); ++iter) {
            ...
            while (ss.good()) {
                ...
                case 6:
                    sales=std::stod(substr);
                    break;

                case 7:
                    Esize=std::stod(substr);
                    break;

                case 8:
                    Hpower=std::stod(substr);
                    break;

                case 9:
                    Wbase=std::stod(substr);
                    break;
                case 10:
                    Width=std::stod(substr);
                    break;
                case 11:
                    Lenght=std::stod(substr);
                    break;
                case 12:
                    Fuel=std::stod(substr);
                    break;
                case 13:
                    FuelE=std::stod(substr);
                    break;

                case 14:
                    Power=std::stod(substr);
